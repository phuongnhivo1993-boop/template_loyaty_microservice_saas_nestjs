    ...
    <div className="page-layout">
      ...
      <main className="main-content">
        ...
        <div className="toolbar">
          ...
          <input type="text" placeholder="Search products..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); updateUrl({ search: e.target.value, status: statusFilter, deleted: showDeleted ? 'true' : undefined }); }} className="search-input" />
